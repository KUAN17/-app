Router.register('investments', (() => {
  ...
  const BUILTIN_STOCKS = [
    {code:'0050',name:'元大台灣50',market:'上市'},{code:'0056',name:'元大高股息',market:'上市'},
    {code:'006208',name:'富邦台50',market:'上市'},{code:'00646',name:'元大S&P500',market:'上市'},
    {code:'00878',name:'國泰永續高股息',market:'上市'},{code:'00919',name:'群益台灣精選高息',market:'上市'},
    {code:'00929',name:'復華台灣科技優息',market:'上市'},{code:'00940',name:'元大台灣價值高息',market:'上市'},
    {code:'1101',name:'台泥',market:'上市'},{code:'1301',name:'台塑',market:'上市'},
    {code:'2002',name:'中鋼',market:'上市'},{code:'2303',name:'聯電',market:'上市'},
    {code:'2308',name:'台達電',market:'上市'},{code:'2317',name:'鴻海',market:'上市'},
    {code:'2330',name:'台積電',market:'上市'},{code:'2382',name:'廣達',market:'上市'},
    {code:'2412',name:'中華電',market:'上市'},{code:'2454',name:'聯發科',market:'上市'},
    {code:'2603',name:'長榮',market:'上市'},{code:'2881',name:'富邦金',market:'上市'},
    {code:'2882',name:'國泰金',market:'上市'},{code:'2884',name:'玉山金',market:'上市'},
    {code:'2886',name:'兆豐金',market:'上市'},{code:'2891',name:'中信金',market:'上市'},
    {code:'3008',name:'大立光',market:'上市'},{code:'3711',name:'日月光投控',market:'上市'},
    {code:'5880',name:'合庫金',market:'上市'},{code:'6505',name:'台塑化',market:'上市'},

window.CFG = {
  ...
  CATEGORIES: {
    '支出': ['食物','飲料','交通','購物','娛樂','家用','電信','醫藥','教育','醫療保險','投資儲蓄','旅遊','訂閱'],
  ...
  // 分類固定色：同一分類在環圈圖/清單中永遠同色，跨月份不變（未列者以名稱雜湊配色）
  CAT_COLORS: {
    '食物':'#5B8DEF','飲料':'#38BDF8','交通':'#34C99A','購物':'#FF8A65',
    '娛樂':'#A78BFA','家用':'#FFC757','電信':'#60A5FA','醫藥':'#F87171',
    '教育':'#F472B6','醫療保險':'#FB923C','投資儲蓄':'#2DD4BF','旅遊':'#22C3E6',
    '訂閱':'#C084FC','其他':'#94A3B8','未分類':'#94A3B8'
  },

  CAT_REPAYMENT: '代付補款',
  CAT_ADJUST: '調帳',
  CAT_CARD_BILL: '信用卡費', // 繳卡費屬還債非消費，統計時排除避免與刷卡消費重複計算
